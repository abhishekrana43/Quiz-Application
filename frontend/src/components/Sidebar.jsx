...
import { Award, BookOpen, ChevronDown, Code, Coffee, Cpu, Database, Globe, Layout, Sparkles, Star, Target, Trophy, Zap, Menu, CheckCircle, XCircle, Terminal } from 'lucide-react'
...
const Sidebar = () => {
 ...
 const [selectedTech, setSelectedTech] = useState(null);
  ...
  const handleAnswerSelect = (annswerIndex) => {
    const newAnswers = {
        ...userAnswers,
        [currentQuestion]: annswerIndex
    };
                ...
                <div className={sidebarStyles.headerDecoration1}> 
                    <div className={sidebarStyles.headerDecoration2}>
                        <div className={sidebarStyles.headerContent}>
                            ...
                            <h1 className={sidebarStyles.logoTitle}>Tech Quiz Master
                            </h1>
                            <p className={sidebarStyles.logoSubtitle}>
                                Test your knowledge & imporove skills
                            </p>
                        </div>
                    </div>
                    <button
                  ...
                  <button onClick={() => handleTechSelect(tech.id)}
                    className={`${sidebarStyles.techButton} ${selectedTech === tech.id
                        ...
                        <div className={sidebarStyles.techButtonContent}>
                            <span className={`${sidebarStyles.techButtonContent} ${tech.color}`}>
                                {tech.icon}
